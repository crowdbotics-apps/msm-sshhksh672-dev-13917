...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    ...
    case types.API_V1_WS_LIST:
    case types.API_V1_WS_LIST_SUCCEEDED:
    case types.API_V1_WS_LIST_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    case types.API_V1_WS_CREATE:
    case types.API_V1_WS_CREATE_SUCCEEDED:
    case types.API_V1_WS_CREATE_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    case types.API_V1_WS_READ:
    case types.API_V1_WS_READ_SUCCEEDED:
    case types.API_V1_WS_READ_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    case types.API_V1_WS_UPDATE:
    case types.API_V1_WS_UPDATE_SUCCEEDED:
    case types.API_V1_WS_UPDATE_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    case types.API_V1_WS_PARTIAL_UPDATE:
    case types.API_V1_WS_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_WS_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
    case types.API_V1_WS_DELETE:
    case types.API_V1_WS_DELETE_SUCCEEDED:
    case types.API_V1_WS_DELETE_FAILED:
      return Object.assign({}, state, {
        mSMsshhkshAPI: [...state.mSMsshhkshAPI, action.response]
      })
