...
export const api_v1_ws_list = () => ({ type: types.API_V1_WS_LIST })
export const api_v1_ws_listSucceeded = (response, starter) => ({
  type: types.API_V1_WS_LIST_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_listFailed = (error, starter) => ({
  type: types.API_V1_WS_LIST_FAILED,
  error,
  starter
})

export const api_v1_ws_create = data => ({ type: types.API_V1_WS_CREATE, data })
export const api_v1_ws_createSucceeded = (response, starter) => ({
  type: types.API_V1_WS_CREATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_createFailed = (error, starter) => ({
  type: types.API_V1_WS_CREATE_FAILED,
  error,
  starter
})

export const api_v1_ws_read = () => ({ type: types.API_V1_WS_READ })
export const api_v1_ws_readSucceeded = (response, starter) => ({
  type: types.API_V1_WS_READ_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_readFailed = (error, starter) => ({
  type: types.API_V1_WS_READ_FAILED,
  error,
  starter
})

export const api_v1_ws_update = data => ({ type: types.API_V1_WS_UPDATE, data })
export const api_v1_ws_updateSucceeded = (response, starter) => ({
  type: types.API_V1_WS_UPDATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_updateFailed = (error, starter) => ({
  type: types.API_V1_WS_UPDATE_FAILED,
  error,
  starter
})

export const api_v1_ws_partial_update = data => ({
  type: types.API_V1_WS_PARTIAL_UPDATE,
  data
})

export const api_v1_ws_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_WS_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_WS_PARTIAL_UPDATE_FAILED,
  error,
  starter
})

export const api_v1_ws_delete = () => ({ type: types.API_V1_WS_DELETE })
export const api_v1_ws_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_WS_DELETE_SUCCEEDED,
  response,
  starter
})

export const api_v1_ws_deleteFailed = (error, starter) => ({
  type: types.API_V1_WS_DELETE_FAILED,
  error,
  starter
})
...
export const wsws1_get_users_read = new_param => ({
  type: types.WSWS1_GET_USERS_READ,
  new_param
})
export const wsws1_get_users_readSucceeded = (response, starter) => ({
  type: types.WSWS1_GET_USERS_READ_SUCCEEDED,
  response,
  starter
})
export const wsws1_get_users_readFailed = (error, starter) => ({
  type: types.WSWS1_GET_USERS_READ_FAILED,
  error,
  starter
})
